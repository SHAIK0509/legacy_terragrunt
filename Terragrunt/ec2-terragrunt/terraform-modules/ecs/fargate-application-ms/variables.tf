...
variable "external_domain" {
  description = "The name of the ext domain to deploy"
  type        = string
}
...
variable "commands" {
  description = "start comamnds for task def"
...
variable "desired_count_map" {
  description = "Map of counts for containers for each service"
  type        = any
}
